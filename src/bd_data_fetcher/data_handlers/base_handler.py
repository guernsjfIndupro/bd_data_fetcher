...
class BaseDataHandler:
    ...
    def _manage_excel_sheet(self, file_path: str, sheet_name: str, columns: List[str]) -> Dict[str, pd.DataFrame]:
        """
    ...
    def _append_to_excel_sheet(self, file_path: str, sheet_name: str, data_df: pd.DataFrame, 
        ...
        with pd.ExcelWriter(file_path, engine="openpyxl", mode='a', if_sheet_exists='overlay') as writer:
            ...
            data_df.to_excel(writer, sheet_name=sheet_name, startrow=start_row, index=False, header=False)
    
    def _transform_data_to_sheet_format(self, data_df: pd.DataFrame, column_mapping: Dict[str, str]) -> pd.DataFrame:
        """
    ...
    def _create_matrix_sheet(self, file_path: str, sheet_name: str, data_df: pd.DataFrame,
                           group_field: str, value_field: str, gene_field: str,
                           gene_column_name: str = "Gene") -> pd.DataFrame:
        """
